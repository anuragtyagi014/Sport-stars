...
<div class="container homepage-content">
    ...
    <div class="main-content-column-1<?php if (plsh_gs('sidebar_position') === 'left') {
                                            echo ' right';
                                        } ?>">
        ...
        <div class="blog-block-1 search-results">
            ...
            <div class="search-query-1">
                <div>
                    ...
                    <span class="legend-default"><i class="fa fa-bars"></i><?php echo esc_html($result_count);
                                                                            echo ' ' .  _n('result found', 'results found', $result_count, 'goliath'); ?></span>
                </div>
                <div>
