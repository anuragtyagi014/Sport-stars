	...
	<div class="container homepage-content hfeed">
		<div class="main-content-column-1 full-width">
			...
			<div id="archive-area">
				...
				?>
				<?php $mvp_featured_cat = get_option('gd_featured_slider_cat');
				if ($mvp_featured_cat == "true") { ?>
					<?php if ($paged < 2) : ?>
						<div id="featured-cat">
							<div class="flexslider">
								<ul class="slides">
									...
									?>
									<?php $cat_posts = new WP_Query('showposts=2&cat=' . $cat_id);
					...
					<div id="cat-blog-wrapper">
						<ul>
							...
							$cat_posts = new WP_Query('showposts=2&cat=' . $category_id);
							while ($cat_posts->have_posts()) : $cat_posts->the_post();
								$do_not_duplicate[] = $post->ID; ?>
							<?php endwhile; ?>
