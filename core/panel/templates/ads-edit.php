                        ...
                        if(!empty($ad_data))
                        {
                            foreach($ad_data as $key => $ad_item)
                            {
                                    ...
                                    $ad_item['ad_type'] == 'banner')
                                {
                                    ...
                                    {
                                        ?><a href="<?php echo esc_url($ad_item['ad_link:0']); ?>"><img src="<?php echo esc_url($ad_item['ad_file:0']); ?>" alt="ad" /></a><?php
                                        ?><a href="<?php echo esc_url($ad_item['ad_link:1']); ?>"><img src="<?php echo esc_url($ad_item['ad_file:1']); ?>" alt="ad" /></a><?php
                                        ?><a href="<?php echo esc_url($ad_item['ad_link:2']); ?>"><img src="<?php echo esc_url($ad_item['ad_file:2']); ?>" alt="ad" /></a><?php
                                        ?><a href="<?php echo esc_url($ad_item['ad_link:3']); ?>"><img src="<?php echo esc_url($ad_item['ad_file:3']); ?>" alt="ad" /></a><?php
                                    }
                                    else
                                    {
                                        ?><a href="<?php echo esc_url($ad_item['ad_link']); ?>"><img src="<?php echo esc_url($ad_item['ad_file']); ?>" alt="ad" /></a><?php
                                    }
